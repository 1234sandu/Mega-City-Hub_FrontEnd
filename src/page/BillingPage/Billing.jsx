    ...
    >
      <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 mt-15">
          <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-2xl p-8 border-2 border-green-800">
            ...
            <div className="mb-8">
              <h3 className="text-2xl font-semibold text-green-800 mb-4">Ride Route</h3>
              <GoogleMap
                mapContainerClassName="h-72 w-full rounded-lg shadow-md border-2 border-green-700"
            ...
            <div className="mb-8">
              <label className="flex items-center space-x-2">
                ...
                />
                <span className="text-green-800">Do you need a driver?</span>
              </label>
            </div>
            ...
            <button
              ...
              className={`w-full bg-green-800 text-white py-3 rounded-lg font-semibold transition-all duration-300 ${
                isProcessing
