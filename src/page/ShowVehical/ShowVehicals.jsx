...
const AdminVehiclesPage = () => {
  ...
  const getStatusColor = (available) => {
    return available ? 'bg-green-700' : 'bg-yellow-500';
  };
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-green-900 rounded-lg shadow-lg overflow-hidden">
            <table className="w-full text-left">
              <thead>
                <tr className="bg-green-800 text-yellow-400">
              ...
              <tbody>
                {vehiclesData.map((vehicle) => (
                  <tr key={vehicle.carId} className="border-t border-green-700 text-white">
                    ...
                    <td className="p-4 flex gap-2">
                      <button
                        ...
                        className="bg-green-700 text-white px-3 py-1 rounded-full hover:bg-green-600 transition-colors"
                      >
                        View
                      </button>
                      <button
                        onClick={() => handleDeleteClick(vehicle.carId)}
                        className="bg-yellow-500 text-white px-3 py-1 rounded-full hover:bg-yellow-400 transition-colors"
                      >
                        Delete
                      </button>
                    </td>
