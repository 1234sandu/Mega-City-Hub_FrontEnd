  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white p-6 flex items-center justify-center">
        <p className="text-green-800">Loading customers...</p>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-green-800 rounded-lg shadow-lg overflow-hidden">
          <table className="w-full text-left">
            <thead>
              <tr className="bg-green-900 text-yellow-300">
            ...
            <tbody>
              {customersData.map((customer) => (
                <tr key={customer.id} className="border-t border-green-700 text-white hover:bg-green-700">
                  ...
                  <td className="p-4">
                    <button
                      ...
                      className="bg-yellow-400 text-green-900 px-3 py-1 rounded-full hover:bg-yellow-300 transition-colors font-medium"
                    >
                      View
                    </button>
                  </td>
