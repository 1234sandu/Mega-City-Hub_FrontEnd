    ...
    return (
      <div className="min-h-screen bg-green-900 flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <Link
            to="/login"
            className="block w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-green-900 bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition-colors"
          >
            Back to Login
          </Link>
        </div>
              ...
              <div className="flex gap-2 justify-between mb-4">
                {otp.map((digit, index) => (
                  <input
                    ...
                    onPaste={handlePaste}
                    className="w-12 h-12 text-center border border-green-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500"
                    disabled={isLoading}
                  />
                ))}
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="block w-full pr-10 py-2 border border-green-300 rounded-md shadow-sm focus:ring-yellow-500 focus:border-yellow-500"
                  disabled={isLoading}
                />
                <button
                  type="button"
                ...
                >
                  {showPassword ? (
                    <EyeOffIcon className="h-5 w-5 text-green-600" />
                  ) : (
